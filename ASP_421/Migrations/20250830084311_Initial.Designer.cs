...
namespace ASP_421.Migrations
{
    ...
    [Migration("20250830084311_Initial")]
            ...
            modelBuilder.Entity("ASP_421.Data.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            BirthDate = new DateTime(2025, 8, 30, 11, 43, 10, 3, DateTimeKind.Local).AddTicks(3490),
                            Email = "admin@i.ua",
                            Name = "Root Administrator",
                            RegisteredAt = new DateTime(2025, 8, 30, 11, 43, 10, 12, DateTimeKind.Local).AddTicks(9942)
                        });
                });
            ...
            modelBuilder.Entity("ASP_421.Data.Entities.UserAccess", b =>
                {
                    ...
                    b.ToTable("UserAccesse");

                    b.HasData(
                        new
                        {
                            Id = new Guid("f53c3536-00be-4095-a204-4722196ff284"),
